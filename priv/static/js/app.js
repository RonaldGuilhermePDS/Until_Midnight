...
`, template.innerHTML.trim());
  ...
  import_topbar.default.config({ barColors: { 0: "#FFB800" }, shadowColor: "rgba(0, 0, 0, .2)" });
  window.addEventListener("phx:page-loading-start", () => import_topbar.default.show());
