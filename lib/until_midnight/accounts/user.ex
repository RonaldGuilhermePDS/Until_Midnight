defmodule UntilMidnight.Accounts.User do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, UntilMidnight.Repo)
  ...
  """
  def valid_password?(%UntilMidnight.Accounts.User{hashed_password: hashed_password}, password)
